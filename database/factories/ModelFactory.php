...
$factory->define(App\Models\ChoiceQuestion::class, function (Faker\Generator $faker) {
   $date_time = $faker->date . ' ' . $faker->time;
...
$factory->define(App\Models\CompletionQuestion::class, function (Faker\Generator $faker) {
    $date_time = $faker->date . ' ' . $faker->time;
...
$factory->define(App\Models\CalculationQuestion::class, function (Faker\Generator $faker) {
    $date_time = $faker->date . ' ' . $faker->time;
